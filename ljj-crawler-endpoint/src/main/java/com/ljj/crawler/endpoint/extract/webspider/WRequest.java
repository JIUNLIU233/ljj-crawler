package com.ljj.crawler.endpoint.extract.webspider;


import com.alibaba.fastjson.JSONObject;
import com.ljj.crawler.endpoint.core.AppContext;
import com.ljj.crawler.endpoint.extract.webspider.http.Method;
...
import com.ljj.crawler.endpoint.extract.webspider.http.downloader.Downloader;
import com.ljj.crawler.endpoint.extract.webspider.http.downloader.HttpClientDownloader;
import com.ljj.crawler.endpoint.extract.webspider.http.downloader.JsoupDownloader;
...
public class WRequest {
    ...
    public static WRequest create(Request request) {
        WRequest wRequest = new WRequest(request.getTaskId());
